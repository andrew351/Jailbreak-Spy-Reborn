...
WarningLabel.Text = "Kikoo likes spaghett"
...
Shadow_7.Text = "Kikoo likes spaghett"
...
Shadow_8.Text = "Kikoo likes spaghett"
...
Shadow_9.Text = "Kikoo likes spaghett"
...
WarningLabel_2.Text = "Kikoo likes spaghett"
...
Shadow_16.Text = "Kikoo likes spaghett"
...
Shadow_17.Text = "Kikoo likes spaghett"
...
Shadow_18.Text = "Kikoo likes spaghett"
...
Credits.Text = "certified_roadman@robloxscripts.net"
...
function LoadR2S(obj,args)
	...
	local TextToLoad = [[local network;
for i,v in next, getgc(true) do
	...
	GenerateScript()
	TextToLoad = TextToLoad.."\nnetwork:FireServer(unpack(Arguments));"
...
Client.FireServerT.FireServer = function(a,...)
    ...
    if Args[1] and Args[1] ~= SpamHash then
        AddToOutput(ExampleRemote, ReturnArgs(Args))
    end
...
RemoteTab.Spys.Spyer.MouseButton1Down:Connect(function()
	if not SpyingDB then
		...
		RemoteTab.Spys.Spyer.Words.Text = "Kikoo"
